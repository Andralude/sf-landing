  ...
  return (
    <div id="product">
      <div style={{textShadow:'0px 1px 1px gray'}} className="flex flex-col items-center justify-start font-sans min-h-96 bg-gray-50 lg:pt-10 lg:pb-20 lg:bg-hero lg:bg-cover">
        ...
        <div>
          <p className="p-4 pt-6 font-sans text-2xl leading-10 text-center text-gray-500 lg:text-gray-200 titlefont">
            {description}
          </p>
        </div>
      ...
      <div className="z-0 flex flex-row items-start justify-center w-screen h-[45rem] pt-20 bg-gray-50 lg:bg-white lg:mb-12 lg:w-full md:h-96 lg:pt-0">
          <img className="absolute left-8 sm:left-16 lg:left-auto md:-mt-96 lg:-mt-44 lg:mr-8" src='/assets/Rectangle_1.png' alt=""/>
